...
* `.main` - базовый светлый стиль;
* `.simple` - упрощённый светлый стиль;
* `.dark` - базовый темный стиль;
* `.navMain` - базовый светлый стиль для навигации с акцентом на дороги;
* `.navDark` - базовый темный стиль для навигации с акцентом на дороги.
